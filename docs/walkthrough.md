...
```
The compiled executable is written to `target/release/evergreen-browser.exe`. The release binary is stripped and optimized, typically producing an executable around 1.2 MB.
