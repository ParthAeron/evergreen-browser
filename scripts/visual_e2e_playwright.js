 ...
 * Evaluates all user-facing flows, pages, interstitials, and multi-step installer/uninstaller states for Phase 05 Fixes-2.
 * Directly renders production templates from crates/installer/src/installer_ui.rs, crates/app/src/home_ui.rs,
 * crates/app/src/settings_ui.rs, and crates/app/ui/index.html to guarantee pixel-perfect fidelity.
 */
...
async function runVisualSuite() {
  ...
  // 3. Settings Screen
  console.log('\n[3/7] Verifying Settings Screen (evergreen://settings)...');
  ...
  // 5. Multi-Step Installer Wizard Visual Validation (580x500 Logical Size @ 2x DPI matching Wry/Winit)
  console.log('\n[5/7] Verifying Multi-Step Installer Wizard States (Fluent Dark WebView2)...');
  ...
  // 6. Multi-Step Uninstaller Visual Validation
